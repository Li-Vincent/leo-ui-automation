...
/**
 * An example of using a TestNG DataProviderTest. This used in the sample report to verfiy that ReportNG can deal with
...
public class DataProviderTest {
    ...
    public Iterator<Object[]> dataIterator() {
        return Arrays.asList(new Object[] { "One", 1.0d }, new Object[] { "Two", 2.0d }, new Object[] { "Three", 3.0d })
                .iterator();
    }
